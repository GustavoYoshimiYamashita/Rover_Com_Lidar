...
void setup() {
 ...
 size (1680, 900); // ***MUDE ISTO PARA SUA RESOLUÇÃO DE TELA***
 smooth();
 myPort = new Serial(this,"COM13", 115200); // inicia a comunicação serial
...
void drawRadar() {
  pushMatrix();
  translate(width/2,height/2); // move as coordenadas iniciais para o novo local
  noFill();
  strokeWeight(2);
  stroke(98,245,31);
  ...
  line(0,0,(-width/2)*cos(radians(360)),(-width/2)*sin(radians(360)));
